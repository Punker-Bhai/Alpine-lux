...
printf "${blue}|--------INSTALLING ALPINE IN YOUR TERMUX--------|"
printf "${blue}            BY ~ HACKERSPUNK                     "
...
printf "\n${yellow} You are almost done <\> ;) Cool\n press ENTER to continue\n"
read enter
...
printline
printline
printf "\n${blue} [*] Instagram   :${yellow}    instagram.com/myquotes.hb\n"
printf "$blue [*] Telegram Chennel :${yellow}   t.me/hackerspunk_vk\n"
termux-open-url https://t.me/hackerspunk_vk
printline
